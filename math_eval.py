...
def main(llm, tokenizer, data_name, args):
    ...
    if args.prompt_type in ['direct', 'cot', 'causal', 'causal-consistency', 'causal-steps', 'causal-steps-fewshot', 'cf-arithmetic-base9']:
        # avoid continual generation conditioned on few-shot prompts
        if "deepseek" in args.model_name_or_path:
            stop_words.append("</think>")
        stop_words.extend(["\n\nQuestion:", "\n\nProblem:", "\n\n**Problem:**", "I hope it is correct.", "question:", "Question:", "Problem:", "problem:", "Wait, no, that's not correct. Let me think again.\n\nWait, no, that's correct."])
